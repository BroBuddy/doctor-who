import{_ as e,h as t,m as n,v as r}from"./adventure-DABEB3Ip.js";var i=[{tag:`R001`,title:`Characters and Concepts`,description:`
        ...
        `}],y=()=>v.map(({tag:e,title:t})=>({tag:e,title:t})),b=e=>v.find(t=>t.tag===e),x=e(),S=({type:e,getData:t,className:n})=>{let i=t();return!i||i.length===0?(0,x.jsxs)(`p`,{children:[`No `,e,` data available.`]}):(0,x.jsx)(`div`,{className:n,children:(0,x.jsx)(`div`,{className:`flex flex-wrap`,children:i.map(t=>(0,x.jsx)(r,{to:`/${e}/${t.tag}`,title:t.title,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-1 mb-1 text-center`,children:(0,x.jsx)(`span`,{className:`text-sm`,children:t.tag})},t.tag))})})};function C(){let e=a();return!e||e.length===0?(0,x.jsx)(`p`,{children:`No booklet data available.`}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(t,{icon:`📜`,headline:`Rule Booklet`,children:(0,x.jsx)(S,{type:`rule`,getData:g})}),(0,x.jsx)(t,{icon:`🌀`,headline:`TARDIS Manual`,children:(0,x.jsx)(S,{type:`tardis`,getData:y})}),(0,x.jsx)(t,{icon:`🚀`,headline:`Adventure Booklet`,children:(0,x.jsx)(S,{type:`adventure`,getData:n})}),(0,x.jsx)(t,{icon:`⚔️`,headline:`Enemy Booklet`,children:(0,x.jsx)(S,{type:`enemy`,getData:u})})]})}export{f as a,d as i,b as n,p as o,_ as r,m as s,C as t};