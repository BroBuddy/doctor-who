const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CharactersAndConcepts-Dp49zRd0.js","assets/rule-pages-Dex8WB5V.js","assets/rolldown-runtime-Dw2cE7zH.js","assets/adventure-pages-Da65qfQF.js","assets/adventure-pages-DHUqVbdO.css","assets/TardisCharactersAndFriends-BHt01Ll5.js","assets/Adventures-Dc0ZIpTW.js","assets/ActionsInAdventures-D4x7KoGq.js","assets/Incidents-BvGSKFUQ.js","assets/ActionTables-CJbcVwSZ.js","assets/RuleDetail-CuYpgENk.js","assets/AdventureView-D1aowd2G.js","assets/Badge-Cz-okFPk.js","assets/AdventureLocations-BVQ8wgNX.js","assets/AdventurePlots-DHQfPX5t.js","assets/AdventureCharacters-DeF4HLa_.js","assets/AdventureSpecials-Cd6WsngD.js","assets/EnemyDetail-CQxLY0l6.js","assets/enemy-pages-DZHg47dF.js","assets/EnemyView-BoiOJLYn.js","assets/EnemyGoals-CpS9x4vp.js","assets/EnemyEvents-D2hr3Vcn.js","assets/EnemyLairView-ATafG-tT.js"])))=>i.map(i=>d[i]);
import{r as e}from"./rolldown-runtime-Dw2cE7zH.js";import{_ as t,d as n,f as r,g as i,m as ee,o as a,r as o,u as s,v as c,y as l}from"./adventure-pages-Da65qfQF.js";import{n as u,t as d}from"./vendor-2DwUFvKs.js";import{c as f,d as p,l as m,u as h}from"./rule-pages-Dex8WB5V.js";import{r as g}from"./enemy-pages-DZHg47dF.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var _=e(l(),1),v=u(),y=s(),b=[{to:`/`,label:`Game`},{to:`/booklet`,label:`Booklets`},{to:`/helper`,label:`Helper`}],x=()=>{let e=i();return(0,y.jsx)(`nav`,{className:`mobile-nav`,children:b.map(({to:t,label:r})=>(0,y.jsx)(n,{to:t,className:e.pathname===t?`active`:``,children:r},t))})};function S(){return(0,_.useLayoutEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`instant`})},[i().pathname]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(r,{}),(0,y.jsx)(x,{})]})}var C=[{tag:`R001`,title:`Characters and Concepts`,description:`
        ...
        `}],w=()=>C.map(({tag:e,title:t})=>({tag:e,title:t})),T=[{tag:`T000`,title:`The TARDIS`,description:`
            <p>
                <em>
        ...
        `}],E=()=>T.map(({tag:e,title:t})=>({tag:e,title:t})),D=e=>T.find(t=>t.tag===e),O=({type:e,getData:t,className:r})=>{let i=t();return!i||i.length===0?(0,y.jsxs)(`p`,{children:[`No `,e,` data available.`]}):(0,y.jsx)(`div`,{className:r,children:(0,y.jsx)(`div`,{className:`flex flex-wrap`,children:i.map(t=>(0,y.jsx)(n,{to:`/${e}/${t.tag}`,title:t.title,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-1 mb-1 text-center`,children:(0,y.jsx)(`span`,{className:`text-sm`,children:t.tag})},t.tag))})})};function k(){let e=w();return!e||e.length===0?(0,y.jsx)(`p`,{children:`No booklet data available.`}):(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(h,{icon:`📜`,headline:`Rule Booklet`,children:(0,y.jsx)(O,{type:`rule`,getData:m})}),(0,y.jsx)(h,{icon:`🌀`,headline:`TARDIS Manual`,children:(0,y.jsx)(O,{type:`tardis`,getData:E})}),(0,y.jsx)(h,{icon:`🚀`,headline:`Adventure Booklet`,children:(0,y.jsx)(O,{type:`adventure`,getData:a})}),(0,y.jsx)(h,{icon:`⚔️`,headline:`Enemy Booklet`,children:(0,y.jsx)(O,{type:`enemy`,getData:g})})]})}function A(){return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`p`,{children:`This is storytelling game for one player. You read various numbered sections one at a time, but the sequence of sections is determined by rules and tables. Each describes a new situation, or provides rules about the choices and actions you can make. There are plenty of events and situations, so each game will be a new, fresh experience.`}),(0,y.jsxs)(`p`,{children:[`DWSSG3e has four booklets –`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`Rules, TARDIS Manual, Adventures and Enemy`}),`. You will also need two normal six-sided dice (D6) and tokens or counters to help you keep score of current totals in Adventures.`]}),(0,y.jsxs)(`p`,{children:[`The `,(0,y.jsx)(`strong`,{children:`Adventures`}),` booklet details all the incredible locations that the TARDIS can visit (and has sections that begin with ‘A’). The`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`Enemy`}),` booklet describes the various villains and aliens that oppose the Doctor (with sections that begin with ‘E’). The`,` `,(0,y.jsx)(`strong`,{children:`TARDIS Manual`}),` details how to fly the incredible ship between Adventures (with sections that begin with ‘V’, ‘Q’ and ‘T’). This `,(0,y.jsx)(`strong`,{children:`Rules`}),` booklet (with sections that begin with ‘R’) describes how to play the game and includes all the reference tables.`]})]})}function j(){return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsxs)(`p`,{children:[`DWSSG3e consists of a series of Adventures (see r006). An Adventure is reached by using the`,` `,(0,y.jsx)(`strong`,{className:`mr-1`,children:`TARDIS Manual`}),`(see also r004). An Adventure is played out as a series of Turns. A standard Turn starts with you selecting an Action (r008), such as Exploring, Planning or Investigating. Depending on the Action selected, you are usually referred to a chart, where you roll 2D6. The result will describe what has happened and give further effects on the Adventure.`]}),(0,y.jsxs)(`p`,{children:[`After each Action, roll 2D6 on the Enemy Action Table (r009) to see if your Enemy has advanced their diabolical plan or if you have encountered them. If you do have an encounter, then you consult the `,(0,y.jsx)(`strong`,{children:`Enemy`}),` Booklet.`]}),(0,y.jsx)(`p`,{children:`Some Adventures have keywords such as Dark or Exterior, which modify encounters. Most Locations in Adventures have Encounter lines which you roll on each Turn. Some Encounters may lead to Conflicts (r010) or you may meet Characters who join you as Allies. These additional Characters are useful in fights and have skills, knowledge or abilities that are useful in certain events and help you Defeat the Enemy. Some Characters can also become Companions (r002) who join you on your Adventures in the TARDIS. Of course, the Doctor always has some handy Gadgets (r005) to help in tight spots.`}),(0,y.jsxs)(`p`,{children:[`In an Adventure, you need to Defeat an Enemy (r007). The Enemy is unknown at the start of the Adventure. By taking Actions and gaining `,(0,y.jsx)(`strong`,{children:`Knowledge`}),` to find out what has been happening, you will reveal the Enemy. This is called the`,` `,(0,y.jsx)(`strong`,{children:`Discover Phase`}),`. Once you know the identity of the Enemy you must gain more `,(0,y.jsx)(`strong`,{children:`Knowledge`}),` to reveal their Goal. This is called the`,` `,(0,y.jsx)(`strong`,{children:`Dilemma Phase`}),`. Once the Goal is known, in the`,` `,(0,y.jsx)(`strong`,{children:`Defeat Phase`}),` you then try to defeat the Enemy by choosing an option on the Goal and making various rolls and Actions, such as Prevent Actions.`]}),(0,y.jsxs)(`p`,{children:[`However, the Enemy is never idle and always getting closer to completing their plans. You will have to track the current`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`Danger`}),` in the Adventure and you will lose an Adventure if the`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`Danger`}),` total is ever 20 or more.`]}),(0,y.jsxs)(`p`,{children:[`Defeating an Enemy will gain you `,(0,y.jsx)(`strong`,{children:`Victory Points`}),` `,`(VP). You need`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`30 VP`}),` to win the game. If the Enemy succeeds in their plan however, you must roll on the Setback table (r015) that can result in you losing`,` `,(0,y.jsx)(`strong`,{children:`VP`}),` (or worse). Once you finish an Adventure by successfully Defeating an Enemy or not, you return to the`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`TARDIS Manual`}),` and journey onwards (r012).`]}),(0,y.jsxs)(`p`,{children:[`To start the game, a player should read through rule sections (r001-r012) and then select or create a Doctor (r002) to play. The player then starts at their matching TARDIS section in the`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`TARDIS Manual`}),` (T00 if creating a new Doctor).`]})]})}function M(){return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`p`,{children:`In DWSSG3e there are quite striking changes to the way the game is played from previous editions and 1e/2e players should read through these entire rules first.`}),(0,y.jsxs)(`p`,{children:[`This has included a complete re-design of the structure of the`,(0,y.jsx)(`strong`,{className:`ml-1`,children:`Adventure`}),` and`,` `,(0,y.jsx)(`strong`,{children:`Enemy`}),` book, the addition of a`,` `,(0,y.jsx)(`strong`,{children:`TARDIS Manual`}),` and the removal of the Event book. This will increase the storytelling aspect of the game and vastly reduce the amount of ‘flipping’ between booklets in the game. Systems such as combat have also been streamlined into Conflicts and a simple die roll.`]}),(0,y.jsx)(`p`,{children:`In addition, physical components such as TARDIS Crew cards, Gadget cards, and TARDIS Mats for each Doctor, have been designed to add to visual appeal and help the tracking of the Adventures using simple counters or tokens. A new concept for DWSSG3e is the introduction of Idea cards to give a player ways to influence the game.`})]})}function N(){return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(p,{children:`Doctor Who: Solitaire Story Game`}),(0,y.jsx)(h,{icon:`👋`,headline:`Welcome`,children:(0,y.jsx)(A,{})}),(0,y.jsx)(h,{icon:`🎲`,headline:`How to Play`,children:(0,y.jsx)(j,{})}),(0,y.jsx)(h,{icon:`📝`,headline:`Third Edition Changes`,children:(0,y.jsx)(M,{})})]})}var P=e=>{switch(e.charAt(0)){case`A`:return`adventure`;case`E`:return`enemy`;case`R`:return`rule`;default:return`tardis`}},F=e=>e<0?`${Math.abs(e)} BCE`:`${e} CE`;function I(){let e=JSON.parse(localStorage.getItem(`doctor-who-game`)||`[]`);return(0,y.jsxs)(h,{icon:`⏳`,headline:`History`,children:[(0,y.jsx)(`p`,{children:(0,y.jsx)(`em`,{children:`"The TARDIS can remember your last 15 destinations, ready to take you back at a moment's notice."`})}),e&&e.map((e,t)=>(0,y.jsxs)(`div`,{className:`flex justify-start items-center`,children:[(0,y.jsx)(n,{to:`/${P(e.tag)}/${e.tag}`,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-1 mb-1 text-center`,children:(0,y.jsx)(`span`,{className:`text-sm`,children:e.tag})}),(0,y.jsx)(`span`,{className:`text-dark-grey text-sm flex-1 px-2`,children:e.title})]},t))]})}var L=({items:e})=>!e||e.length===0?null:(0,y.jsx)(h,{icon:`⭐`,headline:`Frequently Used`,children:e.map(e=>(0,y.jsxs)(`div`,{className:`flex justify-start items-center`,children:[(0,y.jsx)(n,{to:`/${P(e.tag)}/${e.tag}`,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-2 mb-1 text-center`,children:(0,y.jsx)(`span`,{className:`text-sm`,children:e.tag})}),(0,y.jsx)(`span`,{className:`text-sm`,children:e.title})]},e.tag))});function te(){let e=o(e=>e.adventure),t=o(e=>e.enemy);return(0,y.jsx)(y.Fragment,{children:(0,y.jsxs)(h,{icon:`🚀`,headline:`Current Game`,children:[e?.tag?(0,y.jsxs)(`div`,{className:`flex justify-start items-center`,children:[(0,y.jsx)(n,{to:`/adventure/${e.tag}`,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-2 mb-1 text-center`,children:(0,y.jsx)(`span`,{className:`text-sm`,children:e.tag})}),(0,y.jsx)(`span`,{className:`text-sm`,children:e.title})]}):(0,y.jsx)(`p`,{className:`text-xs`,children:(0,y.jsx)(`em`,{children:`"Your journey has just begun; no adventure yet."`})}),t?.tag?(0,y.jsxs)(`div`,{className:`flex justify-start items-center`,children:[(0,y.jsx)(n,{to:`/enemy/${t.tag}`,className:`px-2 pt-1 pb-2 w-3 bg-light-blue rounded mr-2 mb-1 text-center`,children:(0,y.jsx)(`span`,{className:`text-sm`,children:t.tag})}),(0,y.jsx)(`span`,{className:`text-sm`,children:t.title})]}):(0,y.jsx)(`p`,{className:`text-xs`,children:(0,y.jsx)(`em`,{children:`„No enemy has revealed themselves yet – stay alert!“`})})]})})}function R(){let e=o(e=>e.lockedFavorites);return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(te,{}),(0,y.jsx)(L,{items:e}),(0,y.jsx)(I,{})]})}function z(){let{tag:e}=t(),n=(0,_.useMemo)(()=>D(String(e)),[e]),{addToHistory:r}=f();return(0,_.useEffect)(()=>{r(n.tag,n.title)},[r,n]),n?(0,y.jsxs)(y.Fragment,{children:[(0,y.jsxs)(p,{children:[n.tag,`. `,n.title]}),(0,y.jsx)(h,{children:(0,y.jsx)(`div`,{dangerouslySetInnerHTML:{__html:n.description}})})]}):null}var B=(0,_.lazy)(()=>c(()=>import(`./CharactersAndConcepts-Dp49zRd0.js`),__vite__mapDeps([0,1,2,3,4]))),V=(0,_.lazy)(()=>c(()=>import(`./TardisCharactersAndFriends-BHt01Ll5.js`),__vite__mapDeps([5,1,2,3,4]))),H=(0,_.lazy)(()=>c(()=>import(`./Adventures-Dc0ZIpTW.js`),__vite__mapDeps([6,1,2,3,4]))),U=(0,_.lazy)(()=>c(()=>import(`./ActionsInAdventures-D4x7KoGq.js`),__vite__mapDeps([7,1,2,3,4]))),W=(0,_.lazy)(()=>c(()=>import(`./Incidents-BvGSKFUQ.js`),__vite__mapDeps([8,1,2,3,4]))),G=(0,_.lazy)(()=>c(()=>import(`./ActionTables-CJbcVwSZ.js`),__vite__mapDeps([9,3,2,4,1]))),K=(0,_.lazy)(()=>c(()=>import(`./RuleDetail-CuYpgENk.js`),__vite__mapDeps([10,1,2,3,4]))),q=[{path:`/rule`,element:(0,y.jsx)(r,{}),children:[{path:`R001`,element:(0,y.jsx)(B,{})},{path:`R002`,element:(0,y.jsx)(V,{})},{path:`R006`,element:(0,y.jsx)(H,{})},{path:`R008`,element:(0,y.jsx)(U,{})},{path:`R011`,element:(0,y.jsx)(W,{})},{path:`R014`,element:(0,y.jsx)(G,{})},{path:`:tag`,element:(0,y.jsx)(K,{})}]}];function J(){return(0,y.jsx)(y.Fragment,{children:`🔄`})}var Y=_.lazy(()=>c(()=>import(`./adventure-pages-Da65qfQF.js`).then(e=>e.t),__vite__mapDeps([3,2,4]))),X=_.lazy(()=>c(()=>import(`./AdventureView-D1aowd2G.js`),__vite__mapDeps([11,3,2,4,1,12]))),Z=_.lazy(()=>c(()=>import(`./AdventureLocations-BVQ8wgNX.js`),__vite__mapDeps([13,3,2,4,1]))),Q=_.lazy(()=>c(()=>import(`./AdventurePlots-DHQfPX5t.js`),__vite__mapDeps([14,3,2,4,1]))),ne=_.lazy(()=>c(()=>import(`./AdventureCharacters-DeF4HLa_.js`),__vite__mapDeps([15,3,2,4,1,12]))),re=_.lazy(()=>c(()=>import(`./AdventureSpecials-Cd6WsngD.js`),__vite__mapDeps([16,3,2,4,1,12]))),ie=[{path:`/adventure/:tag`,element:(0,y.jsx)(Y,{}),children:[{index:!0,element:(0,y.jsx)(X,{})},{path:`locations`,element:(0,y.jsx)(Z,{})},{path:`plots`,element:(0,y.jsx)(Q,{})},{path:`characters`,element:(0,y.jsx)(ne,{})},{path:`specials`,element:(0,y.jsx)(re,{})}]}],ae=(0,_.lazy)(()=>c(()=>import(`./EnemyDetail-CQxLY0l6.js`),__vite__mapDeps([17,18,2,3,4]))),oe=(0,_.lazy)(()=>c(()=>import(`./EnemyView-BoiOJLYn.js`),__vite__mapDeps([19,3,2,4,1,12,18]))),$=(0,_.lazy)(()=>c(()=>import(`./EnemyGoals-CpS9x4vp.js`),__vite__mapDeps([20,3,2,4,1,18]))),se=(0,_.lazy)(()=>c(()=>import(`./EnemyEvents-D2hr3Vcn.js`),__vite__mapDeps([21,3,2,4,1,18]))),ce=(0,_.lazy)(()=>c(()=>import(`./EnemyLairView-ATafG-tT.js`),__vite__mapDeps([22,3,2,4,1,12,18]))),le=[{path:`/enemy/:tag`,element:(0,y.jsx)(ae,{}),children:[{index:!0,element:(0,y.jsx)(oe,{})},{path:`goals`,element:(0,y.jsx)($,{})},{path:`events`,element:(0,y.jsx)(se,{})},{path:`lair`,element:(0,y.jsx)(ce,{})}]}],ue=ee([{element:(0,y.jsx)(S,{}),children:[{path:`/`,element:(0,y.jsx)(N,{})},{path:`/booklet`,element:(0,y.jsx)(k,{})},{path:`/helper`,element:(0,y.jsx)(R,{})},{path:`/tardis/:tag`,element:(0,y.jsx)(z,{})},...q,...ie,...le]}]);function de(){return(0,y.jsx)(_.Suspense,{fallback:(0,y.jsx)(J,{}),children:(0,y.jsx)(d,{router:ue})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,y.jsx)(_.StrictMode,{children:(0,y.jsx)(de,{})}));export{F as t};